      ...
      '<div class="ih-footer-inner">' +
        '<div class="ih-footer-content">' +
          ...
          '<div class="ih-footer-actions">' +
            '<a class="ih-cta ih-cta-primary" href="https://t.me/mocklabessential" target="_blank" rel="noopener noreferrer" aria-label="Join Telegram channel: mocklabessential">' +
              '<span class="ih-cta-icon">' + TELEGRAM_SVG + '</span>' +
              '<span class="ih-cta-text">' +
                '<span class="ih-cta-label">Join Channel</span>' +
                '<span class="ih-cta-handle">@mocklabessential</span>' +
              '</span>' +
